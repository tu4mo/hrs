...
const ENTRY_BREAK = 'break'
const ENTRY_LUNCH = 'lunch'
const ENTRY_NOTE = 'note'

const getHeader = ({ startTime, endTime, lunchStartTime, lunchEndTime }) =>
...
const getOverview = data => {
  ...
  const lunchEndTime = addHours(
    lunchStartTime,
    lunchEntries[lunchStartTime].duration
  )
